...
The code for verification  can be found here :  https://github.com/RIT-CHAOS-SEC/generic-verifier

The code for instrumentation can be found here : https://github.com/RIT-CHAOS-SEC/AssemblyInstrumenting 
